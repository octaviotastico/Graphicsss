...
void testDrawAffineCombinationP3(RenderWindow* screen) {
  ...
  drawAffineCombinationP3(&curveArray1, p0, p00, p000, iters1);
  ...
  drawAffineCombinationP3(&curveArray2, p1, p2, p3, iters2);
  ...
  drawAffineCombinationP3(&curveArray3, p4, p5, p6, iters3);
  ...
  drawAffineCombinationP3(&curveArray4, p7, p8, p9, iters4);
  ...
  drawAffineCombinationP3(&curveArray5, p10, p11, p12, iters5);
  ...
  drawAffineCombinationP3(&curveArray100, p13, p14, p15, iters100);
