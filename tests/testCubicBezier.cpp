...
void testCubicBezier(RenderWindow* screen) {
  ...
  cubicBezier(&curveArray1, p1, p2, p3, p4, iters1);
  ...
  cubicBezier(&curveArray2, p5, p6, p7, p8, iters2);
  ...
  cubicBezier(&curveArray3, p9, p10, p11, p12, iters3);
  ...
  cubicBezier(&curveArray4, p13, p14, p15, p16, iters4);
